 ...
 *
 * This servlet can be reached at http://localhost:2990/jira/plugins/servlet/openid-authentication-license
 */
public class LicenseServlet extends HttpServlet
{
    public static final String TEMPLATE = "views/license-admin.vm";
    ...
    private Map<String, Object> initVelocityContext(HttpServletResponse resp)
    {
        ...
        URI servletUri = URI.create(applicationProperties.getBaseUrl() + "/plugins/servlet/openid-authentication-license");
